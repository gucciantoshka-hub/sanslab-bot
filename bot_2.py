...
DASHBOARD_URL = "https://gucciantoshka-hub.github.io/sanslab-dashboard/life_os_dashboard_24.html"

BOT_TOKEN     = os.getenv("BOT_TOKEN", "8603036898:AAH5aTd6ui9FmNU6zOvemenJlz5sfCkatI0")
SUPABASE_URL  = os.getenv("SUPABASE_URL", "https://cbfztoaeyvepxnwvayyk.supabase.co")
SUPABASE_KEY  = os.getenv("SUPABASE_KEY", "sb_publishable_Rnhs6OvSqHsQsn14nsRekg_ouO-32fl")
ANTHROPIC_KEY = os.getenv("ANTHROPIC_KEY", "ВСТАВЬ_СЮДА_СВОЙ_КЛЮЧ_sk-ant-...")
ALLOWED_USER  = os.getenv("ALLOWED_USER_ID", "6138343624")
...
async def cmd_dashboard(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    if not allowed(update): return
    await update.message.reply_text("📊 Твой дашборд:", reply_markup=dashboard_kb())
